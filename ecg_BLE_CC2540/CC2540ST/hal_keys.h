...
#define HAL_KEY_SW_1_ICTLBIT  BV(4) /* P0IEN - P0.0 enable/disable bit */
...
#define HAL_KEY_SW_2_ICTLBIT  BV(6) /* P0IEN - P1.2 enable/disable bit */
...
#define HAL_KEY_SW_3_ICTLBIT  BV(7) /* P0IEN - P0.2 enable/disable bit */
...
#define HAL_KEY_SW_3_EDGEBIT  BV(2)
/**************************************************************************************************
 * TYPEDEFS
 **************************************************************************************************/
